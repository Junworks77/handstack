...
namespace HandStack.Data.Client
{
    ...
    public sealed class SQLiteClient : IDisposable
    {
        ...
        public DataSet? ExecuteDataSet(string commandText, CommandType dbCommandType, List<SQLiteParameter>? parameters)
        {
            if (parameters != null)
            {
                foreach (SQLiteParameter parameter in parameters)
        ...
        public DataSet? ExecuteDataSet(string commandText, CommandType dbCommandType, List<SQLiteParameter>? parameters, ExecutingConnectionState connectionState)
        {
            if (parameters != null)
            {
                foreach (SQLiteParameter parameter in parameters)
        ...
        public DataSet? ExecuteDataSet(string procedureName, List<SQLiteParameter>? parameters)
        {
            return ExecuteDataSet(procedureName, parameters, ExecutingConnectionState.CloseOnExit);
        }

        public DataSet? ExecuteDataSet(string procedureName, List<SQLiteParameter>? parameters, ExecutingConnectionState connectionState)
        {
        ...
        public DataSet? ExecuteDataSet(string procedureName, List<SQLiteParameter>? parameters, ExecutingConnectionState connectionState, out SQLiteCommand? outputDbCommand)
        {
            SetDbFactoryCommand(procedureName, parameters);
        ...
        public int ExecuteNonQuery(string commandText, CommandType dbCommandType, List<SQLiteParameter>? parameters)
        {
            if (parameters != null)
            {
                foreach (SQLiteParameter parameter in parameters)
        ...
        {
            return ExecuteReader(commandText, dbCommandType, null) as SQLiteDataReader;
        }

        public SQLiteDataReader? ExecuteReader(string commandText, CommandType dbCommandType, List<SQLiteParameter>? parameters)
        {
            if (parameters != null)
            {
                foreach (SQLiteParameter parameter in parameters)
        ...
        public SQLiteDataReader? ExecuteReader(string procedureName, List<SQLiteParameter>? parameters)
        {
            ...
            return databaseFactory.ExecuteReader(procedureName, CommandType.StoredProcedure, ExecutingConnectionState.CloseOnExit) as SQLiteDataReader;
        }

        public T? ExecutePocoMapping<T>(string commandText, List<SQLiteParameter>? parameters, CommandType dbCommandType = CommandType.StoredProcedure)
        {
            T? results = default(T);
            if (parameters != null)
            {
        ...
        public List<T>? ExecutePocoMappings<T>(string commandText, List<SQLiteParameter>? parameters, CommandType dbCommandType = CommandType.StoredProcedure)
        {
            List<T>? results = null;
            if (parameters != null)
            {
        ...
        public List<dynamic> ExecuteDynamic(string commandText, List<SQLiteParameter>? parameters, CommandType dbCommandType = CommandType.StoredProcedure)
        {
        ...
        public object? ExecuteScalar(string commandText, CommandType dbCommandType, List<SQLiteParameter>? parameters)
        {
            if (parameters != null)
            {
                foreach (SQLiteParameter parameter in parameters)
