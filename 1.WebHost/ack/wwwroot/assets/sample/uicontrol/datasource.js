$w.initializeScript({
    ...
    pageLoad: function () {
        // $this.$data.bindingSource('txtNew', 'master1');
    },

    btnGetValue_click: function () {
        syn.$l.eventLog('btnGetValue_click', JSON.stringify($this.$data.getValue('lstDataTable')));
    },

    btnSetValue_click: function () {
        $this.$data.setValue('lstDataTable', dataSet);
    },

    btnClear_click: function () {
        $this.$data.clear('lstDataTable');
    },
