...
$w.initializeScript({
	...
	btnGetValue_click: function () {
		$l.eventLog('btnGetValue_click', JSON.stringify($this.$chartjs.getValue('chtChart')));
	},

	btnSetValue_click: function () {
		$this.$chartjs.setValue('chtChart', $this.dataSource, $this.metaColumns);
	},

	btnClear_click: function () {
		$this.$chartjs.clear('chtChart');
	}
});