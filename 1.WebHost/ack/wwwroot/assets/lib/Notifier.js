...
Notifier.info = function (message, title) {
	Notifier.notify(message, title, '/assets/img/icon/ico_notification_information.png');
};
Notifier.warning = function (message, title) {
	Notifier.notify(message, title, '/assets/img/icon/ico_notification_warning.png');
};
Notifier.error = function (message, title) {
	Notifier.notify(message, title, '/assets/img/icon/ico_notification_error.png');
};
Notifier.question = function (message, title) {
	Notifier.notify(message, title, '/assets/img/icon/ico_notification_question.png');
};