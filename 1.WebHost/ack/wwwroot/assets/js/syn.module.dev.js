    ...
    var loader = {
        ...
        loadFiles: function () {
            ...
            for (var i = 0; i < loader.styleFiles.length; i++) {
                ...
                style.href = styleFile + loader.argArgs;
                style.type = 'text/css';
    ...
    xhr.onreadystatechange = () => {
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                ...
                if (location.href.indexOf('MainFrame.html') === -1 && isDarkMode == true) {
                    loadFiles.push('/assets/css/dark_mode.css');
                }
